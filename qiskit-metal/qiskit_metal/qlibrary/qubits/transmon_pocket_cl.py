...
#####################################################################
    ...
    def make_charge_line(self):
        ...
        #cl_etcher = draw.buffer(cl_metal, p.cl_gap) Ebru: that was the original version, I changed this line
        cl_etcher = draw.box(+p.cl_gap,-p.cl_gap,-8 * p.cl_width, p.cl_width+p.cl_gap)
