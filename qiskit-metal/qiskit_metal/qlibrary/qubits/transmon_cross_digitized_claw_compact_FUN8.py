...
###################################TRANSMON#############################################################
    ...
    def make_pocket(self, name:str):
        ...
        cross_line = draw.shapely.ops.unary_union([
            draw.LineString([(0, 1*cross_length), (0, 2*cross_length)]),

            draw.LineString([(cross_length, -1/3*cross_length-0*cross_width), (-cross_length, -1/3*cross_length-0*cross_width)]),
            ...
            draw.LineString([(-2.5*cross_length, cross_length), (2.5*cross_length, cross_length)]),
            # draw.LineString([(-3*cross_length, cross_length-cross_width/1.1), (3*cross_length, cross_length-cross_width/1.1)]),
            draw.LineString([(-2.5*cross_length, 1.5*cross_length), (-2.5*cross_length, 0.5*cross_length)]),
            draw.LineString([(2.5*cross_length, 1.5*cross_length), (2.5*cross_length, 0.5*cross_length)]),
