...
from qiskit_metal.qlibrary.qubits.transmon_cross_Tanvir_v3 import TransmonCross_Tanvir_v3


class TransmonCrossFL_Tanvir_v3(TransmonCross_Tanvir_v3):  # pylint: disable=invalid-name
...
#    
        ...
        polys1 = draw.translate(polys1, xoff=p.pos_x-pf.t_gap+pf.t_shift, yoff=p.pos_y-p.cross_length-p.cross_gap-pf.t_inductive_gap-pf.t_gap-pf.t_offset)#-pf.t_width/2)
