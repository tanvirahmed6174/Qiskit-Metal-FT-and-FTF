...
from qiskit_metal.qlibrary.qubits.transmon_cross_fl_Tanvir_v3 import TransmonCrossFL_Tanvir_v3


class TransmonCrossFL_CL_Tanvir_v3(TransmonCrossFL_Tanvir_v3):  # pylint: disable=invalid-name
